...
const loginRequest_1 = require("../requests/auth/loginRequest");
let AuthController = (() => {
    ...
    var AuthController = _classThis = class {
        constructor(authService) {
            ...
            this.login = (request, response) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const result = loginRequest_1.LoginRequest.parse({ email: email, password: password });
                    console.log(result);
                }
                catch (error) {
                    console.log(error.message);
                }
                // const token = await this.authService.login(new LoginDto(email, password));
                // if (!token) {
            ...
            this.register = (request, response) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!(yield this.authService.register(new register_dto_1.RegisterDto(email, password, first_name, last_name)))) {
            ...
            this.user = (request, response) => __awaiter(this, void 0, void 0, function* () {
                ...
                const user = yield this.authService.user(token);
